...
public class BookMyShow {
    ...
    public static void main(String[] args) {
        ...
        Movie ironMan = new Movie("Iron Man",5.0,Genre.ACTION, Language.ENGLISH);

        // Creating Movie object --> Avengers: End Game
        Movie avengers = new Movie("Avengers: End Game",4.8,Genre.ACTION, Language.ENGLISH);

        // Creating Movie object --> The Walk To Remember
        Movie walkToRemember = new Movie("The Walk To Remember",4.7,Genre.ACTION, Language.ENGLISH);

        // Creating Movie object --> HouseFull2
        Movie housefull = new Movie("HouseFull 2", 4.3,Genre.COMEDY, Language.HINDI);
